...
namespace Isaac\LibraryBundle\Controller;
...
use Isaac\LibraryBundle\Entity\Contact;
use Isaac\LibraryBundle\Form\ContactType;
...
class ContactController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IsaacLibraryBundle:Contact')->findAll();
     ...
     * @Method("POST")
     * @Template("IsaacLibraryBundle:Contact:new.html.twig")
     */
    ...
    private function createCreateForm(Contact $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => 'Create New Contact'));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IsaacLibraryBundle:Contact')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IsaacLibraryBundle:Contact:edit.html.twig")
     */
